...
public class PlayerService implements IPlayerService {
	...
	@Override
	public FireResult attackOnOpponentPosition(Coordinate randomPosToAttack, Player opponenetPlayer) {
		...
		// hit or miss
		Ship ship =  shipService.doesShipExistAtAttackPosition(randomPosToAttack, opponenetPlayer.getId());
